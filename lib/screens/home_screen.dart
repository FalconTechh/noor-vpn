...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _onOrbTap() {
    if (_state == VpnUiState.disconnected) {
      ...
      // TODO: replace with real VpnService.instance.connect(_selectedServer)
        ...
        child: SafeArea(
          child: Column(
            children: [
              ...
              GlowOrbButton(state: _state, onTap: _onOrbTap, size: 230),
              const SizedBox(height: 28),
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            colors: [
              AppColors.cyanGlow.withOpacity(0.18),
